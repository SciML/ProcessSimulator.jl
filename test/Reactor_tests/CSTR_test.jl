...
#----------------- CSTR object
Reaction = KineticReactionNetwork(
    substances_user = substances,
...
@named R_101 = CSTR(;
    ...
    guesses = Dict(
        :Cᵢ => [57252.65, 0.0, 0.0, 0.0], :V => 1.9,
        :F_out => (36.3 + 453.6 + 45.4) * 1.0e3 / 3600, :Fʷ_out => (36.3 + 453.6 + 45.4) * 18 / 3600
    )
)
...
u0 = [
    sistema.R_101.Nᵢ[1] => 1.9 * 57252.65, sistema.R_101.Nᵢ[2] => 1.0e-10,
    sistema.R_101.Nᵢ[3] => 1.0e-10, sistema.R_101.Nᵢ[4] => 1.0e-10,
