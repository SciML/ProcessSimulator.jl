...
cons = [connect(source.Out, Drum_101.In),

connect(Drum_101.Outᴸ, Liquid_Valve.In),
...
flowsheet = ODESystem(cons, t; name = :myflowsheet, systems = [Drum_101, source, Liquid_Valve, Vapor_Valve], discrete_events = check_and_block)   
