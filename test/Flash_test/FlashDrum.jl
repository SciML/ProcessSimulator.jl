...
cons = [
    connect(source.Out, Drum_101.In), connect(Drum_101.Outᴸ, Liquid_Valve.In),
    connect(Drum_101.Outᵍ, Vapor_Valve.In),
]

check_and_block = [
    (Drum_101.Vᴸ <= 0.01 * 0.2) => [Liquid_Valve.θ ~ 0.0]
...
u0 = [
    sistema.Drum_101.Nᵢ[1] => 0.0, sistema.Drum_101.Nᵢ[2] => 0.0,
